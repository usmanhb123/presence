...
import 'package:presence/faceModule/model.dart';
...
class PresenceFaceView extends StatefulWidget {
  const PresenceFaceView({Key? key}) : super(key: key);

  @override
  State<PresenceFaceView> createState() => _PresenceFaceViewState();
}

class _PresenceFaceViewState extends State<PresenceFaceView>
